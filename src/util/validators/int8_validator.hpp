#ifndef AWESOMENBTVIEWER_UTIL_VALIDATORS_INT8_VALIDATOR_HPP
#define AWESOMENBTVIEWER_UTIL_VALIDATORS_INT8_VALIDATOR_HPP
...
#endif // AWESOMENBTVIEWER_UTIL_VALIDATORS_INT8_VALIDATOR_HPP